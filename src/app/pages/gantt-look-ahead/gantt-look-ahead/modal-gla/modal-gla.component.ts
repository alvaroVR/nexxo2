...
@Component({
  selector: 'app-modal-gla',
  templateUrl: './modal-gla.component.html',
  styleUrls: ['./modal-gla.component.scss']
})
export class ModalGlaComponent implements OnInit {
  title: string | any;
  message: string | any;
  data: any;
  checkValues: any;
  ...
  constructor(public bsModalRef: BsModalRef,
              private fb: FormBuilder, public common: CommonService, public gantChartService: GanttLookAheadService) {
  }
